...
-- Ajouter toutes les colonnes qu'on veut du dataset
...
BEGIN
    ...
    SELECT @dateFrom, dataset.MandatId, dataset.BudgetMaxEuro, dataset.Ville
    FROM (
        SELECT TOP (100000)
    ...
    WHERE dataset.DateMandat = @dateFrom
END
